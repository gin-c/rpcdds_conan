...
{
    // m_mimeType com.eprosima.idl.parser.typecode.StringTypeCode@7494e528
    m_mimeType ="";
    // m_width com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4bbfb90a
    m_width = 0;
    // m_height com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7c29daf3
    m_height = 0;
...
{
    // m_mimeType com.eprosima.idl.parser.typecode.StringTypeCode@2a17b7b6
    m_mimeType ="";
    // m_sampleRate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4f063c0a
    m_sampleRate = 0;
    // m_channelConfig com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1e6d1014
    m_channelConfig = 0;
    // m_encodingFormat com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76707e36
    m_encodingFormat = 0;
 ...
 * @param _mimeType New value to be copied in member mimeType
 */
void AudioFormat::mimeType(const std::string &_mimeType)
{
m_mimeType = _mimeType;
}
 ...
 * @param _mimeType New value to be moved in member mimeType
 */
void AudioFormat::mimeType(std::string &&_mimeType)
{
m_mimeType = std::move(_mimeType);
}
 ...
 * @return Constant reference to member mimeType
 */
const std::string& AudioFormat::mimeType() const
{
    return m_mimeType;
}
 ...
 * @return Reference to member mimeType
 */
std::string& AudioFormat::mimeType()
{
    return m_mimeType;
}
/*!
 ...
 */
void AudioFormat::sampleRate(int32_t _sampleRate)
{
 ...
 */
int32_t AudioFormat::sampleRate() const
{
    return m_sampleRate;
}
 ...
 */
void AudioFormat::channelConfig(int32_t _channelConfig)
{
m_channelConfig = _channelConfig;
}
 ...
 */
int32_t AudioFormat::channelConfig() const
{
 ...
 */
int32_t& AudioFormat::channelConfig()
{
    return m_channelConfig;
}
 ...
 */
void AudioFormat::encodingFormat(int32_t _encodingFormat)
{
 ...
 */
int32_t AudioFormat::encodingFormat() const
{
 ...
 */
int32_t& AudioFormat::encodingFormat()
{
    return m_encodingFormat;
}
...
MusicInfo::MusicInfo()
{
    // m_artistName com.eprosima.idl.parser.typecode.StringTypeCode@711f39f9
    m_artistName ="";
    // m_albumName com.eprosima.idl.parser.typecode.StringTypeCode@71bbf57e
    m_albumName ="";
    // m_coverArt com.eprosima.idl.parser.typecode.StringTypeCode@7f13d6e
    m_coverArt ="";
    // m_lyrics com.eprosima.idl.parser.typecode.StringTypeCode@51cdd8a
    m_lyrics ="";
    // m_totalTimesMs com.eprosima.idl.parser.typecode.PrimitiveTypeCode@d44fc21
    m_totalTimesMs = 0;
    // m_title com.eprosima.idl.parser.typecode.StringTypeCode@23faf8f2
    m_title ="";
    // m_authorName com.eprosima.idl.parser.typecode.StringTypeCode@2d6eabae
    m_authorName ="";
    // m_writerName com.eprosima.idl.parser.typecode.StringTypeCode@4e7dc304
    m_writerName ="";
    // m_composerName com.eprosima.idl.parser.typecode.StringTypeCode@10bbd20a
    m_composerName ="";
    // m_playingCurrentTimeMs com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6895a785
    m_playingCurrentTimeMs = 0;
    // m_isFavorite com.eprosima.idl.parser.typecode.PrimitiveTypeCode@184f6be2
    m_isFavorite = false;
    // m_isPlaying com.eprosima.idl.parser.typecode.PrimitiveTypeCode@56aac163
    m_isPlaying = false;
 ...
 */
void MusicInfo::artistName(const std::string &_artistName)
{
 ...
 */
void MusicInfo::artistName(std::string &&_artistName)
{
m_artistName = std::move(_artistName);
}
 ...
 */
const std::string& MusicInfo::artistName() const
{
    return m_artistName;
}
 ...
 */
std::string& MusicInfo::artistName()
{
    return m_artistName;
}
/*!
 ...
 */
void MusicInfo::albumName(const std::string &_albumName)
{
 ...
 */
void MusicInfo::albumName(std::string &&_albumName)
{
m_albumName = std::move(_albumName);
}
 ...
 */
const std::string& MusicInfo::albumName() const
{
    return m_albumName;
}
 ...
 */
std::string& MusicInfo::albumName()
{
    return m_albumName;
}
/*!
 ...
 */
void MusicInfo::coverArt(const std::string &_coverArt)
{
m_coverArt = _coverArt;
}
 ...
 */
void MusicInfo::coverArt(std::string &&_coverArt)
{
m_coverArt = std::move(_coverArt);
}
 ...
 */
const std::string& MusicInfo::coverArt() const
{
    return m_coverArt;
}
 ...
 */
void MusicInfo::lyrics(const std::string &_lyrics)
{
m_lyrics = _lyrics;
}
 ...
 */
void MusicInfo::lyrics(std::string &&_lyrics)
{
m_lyrics = std::move(_lyrics);
}
 ...
 */
const std::string& MusicInfo::lyrics() const
{
    return m_lyrics;
}
 ...
 */
void MusicInfo::totalTimesMs(int32_t _totalTimesMs)
{
m_totalTimesMs = _totalTimesMs;
}
 ...
 */
int32_t MusicInfo::totalTimesMs() const
{
    return m_totalTimesMs;
}
 ...
 */
int32_t& MusicInfo::totalTimesMs()
{
    return m_totalTimesMs;
}
 ...
 */
void MusicInfo::title(const std::string &_title)
{
m_title = _title;
}
 ...
 */
void MusicInfo::title(std::string &&_title)
{
 ...
 */
const std::string& MusicInfo::title() const
{
    return m_title;
}
 ...
 */
void MusicInfo::authorName(const std::string &_authorName)
{
 ...
 */
void MusicInfo::authorName(std::string &&_authorName)
{
m_authorName = std::move(_authorName);
}
 ...
 */
const std::string& MusicInfo::authorName() const
{
    return m_authorName;
}
 ...
 */
std::string& MusicInfo::authorName()
{
    return m_authorName;
}
/*!
 ...
 */
void MusicInfo::writerName(const std::string &_writerName)
{
m_writerName = _writerName;
}
 ...
 */
void MusicInfo::writerName(std::string &&_writerName)
{
m_writerName = std::move(_writerName);
}
 ...
 */
const std::string& MusicInfo::writerName() const
{
    return m_writerName;
}
 ...
 */
std::string& MusicInfo::writerName()
{
    return m_writerName;
}
/*!
 ...
 */
void MusicInfo::composerName(const std::string &_composerName)
{
m_composerName = _composerName;
}
 ...
 */
void MusicInfo::composerName(std::string &&_composerName)
{
m_composerName = std::move(_composerName);
}
 ...
 */
const std::string& MusicInfo::composerName() const
{
 ...
 */
std::string& MusicInfo::composerName()
{
    return m_composerName;
}
/*!
 ...
 */
void MusicInfo::playingCurrentTimeMs(int32_t _playingCurrentTimeMs)
{
m_playingCurrentTimeMs = _playingCurrentTimeMs;
}
 ...
 */
int32_t MusicInfo::playingCurrentTimeMs() const
{
    return m_playingCurrentTimeMs;
}
 ...
 */
int32_t& MusicInfo::playingCurrentTimeMs()
{
    return m_playingCurrentTimeMs;
}
 ...
 */
void MusicInfo::isFavorite(bool _isFavorite)
{
 ...
 */
bool MusicInfo::isFavorite() const
{
    return m_isFavorite;
}
 ...
 */
void MusicInfo::isPlaying(bool _isPlaying)
{
 ...
 */
bool MusicInfo::isPlaying() const
{
    return m_isPlaying;
}
...
{
    // m_isNavigating com.eprosima.idl.parser.typecode.PrimitiveTypeCode@53f65459
    m_isNavigating = false;
    // m_directionIcon com.eprosima.idl.parser.typecode.SequenceTypeCode@3b088d51

    // m_distance com.eprosima.idl.parser.typecode.StringTypeCode@1786dec2
    m_distance ="";
    // m_distanceUnit com.eprosima.idl.parser.typecode.StringTypeCode@74650e52
    m_distanceUnit ="";
    // m_operation com.eprosima.idl.parser.typecode.StringTypeCode@15d0c81b
    m_operation ="";
    // m_where com.eprosima.idl.parser.typecode.StringTypeCode@6acdbdf5
    m_where ="";
    // m_title1 com.eprosima.idl.parser.typecode.StringTypeCode@4b1c1ea0
    m_title1 ="";
    // m_title2 com.eprosima.idl.parser.typecode.StringTypeCode@17579e0f
    m_title2 ="";
...
size_t NavigationInfo::getCdrSerializedSize(const NavigationInfo& data, size_t current_alignment)
{
    ...
    {
        current_alignment += (data.directionIcon().size() * 1) + eprosima::fastcdr::Cdr::alignment(current_alignment, 1);
    }
 ...
 */
void NavigationInfo::isNavigating(bool _isNavigating)
{
m_isNavigating = _isNavigating;
}
 ...
 */
bool NavigationInfo::isNavigating() const
{
 ...
 */
bool& NavigationInfo::isNavigating()
{
    return m_isNavigating;
}
 ...
 */
void NavigationInfo::directionIcon(const std::vector<char> &_directionIcon)
{
m_directionIcon = _directionIcon;
}
 ...
 */
void NavigationInfo::directionIcon(std::vector<char> &&_directionIcon)
{
m_directionIcon = std::move(_directionIcon);
}
 ...
 */
const std::vector<char>& NavigationInfo::directionIcon() const
{
 ...
 */
std::vector<char>& NavigationInfo::directionIcon()
{
    return m_directionIcon;
}
/*!
 ...
 */
void NavigationInfo::distance(const std::string &_distance)
{
 ...
 */
void NavigationInfo::distance(std::string &&_distance)
{
m_distance = std::move(_distance);
}
 ...
 */
const std::string& NavigationInfo::distance() const
{
    return m_distance;
}
 ...
 */
std::string& NavigationInfo::distance()
{
    return m_distance;
}
/*!
 ...
 */
void NavigationInfo::distanceUnit(const std::string &_distanceUnit)
{
 ...
 */
void NavigationInfo::distanceUnit(std::string &&_distanceUnit)
{
m_distanceUnit = std::move(_distanceUnit);
}
 ...
 */
const std::string& NavigationInfo::distanceUnit() const
{
 ...
 */
std::string& NavigationInfo::distanceUnit()
{
    return m_distanceUnit;
}
/*!
 ...
 */
void NavigationInfo::operation(const std::string &_operation)
{
 ...
 */
void NavigationInfo::operation(std::string &&_operation)
{
 ...
 */
const std::string& NavigationInfo::operation() const
{
    return m_operation;
}
 ...
 */
std::string& NavigationInfo::operation()
{
    return m_operation;
}
/*!
 ...
 */
void NavigationInfo::where(const std::string &_where)
{
m_where = _where;
}
 ...
 */
void NavigationInfo::where(std::string &&_where)
{
m_where = std::move(_where);
}
 ...
 */
const std::string& NavigationInfo::where() const
{
    return m_where;
}
 ...
 */
std::string& NavigationInfo::where()
{
    return m_where;
}
/*!
 ...
 */
void NavigationInfo::title1(const std::string &_title1)
{
m_title1 = _title1;
}
 ...
 */
void NavigationInfo::title1(std::string &&_title1)
{
m_title1 = std::move(_title1);
}
 ...
 */
const std::string& NavigationInfo::title1() const
{
    return m_title1;
}
 ...
 */
std::string& NavigationInfo::title1()
{
    return m_title1;
}
/*!
 ...
 */
void NavigationInfo::title2(const std::string &_title2)
{
m_title2 = _title2;
}
 ...
 */
void NavigationInfo::title2(std::string &&_title2)
{
m_title2 = std::move(_title2);
}
 ...
 */
const std::string& NavigationInfo::title2() const
{
    return m_title2;
}
 ...
 */
std::string& NavigationInfo::title2()
{
    return m_title2;
}
...
{
    // m_phoneCs com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d8f65a4
    m_phoneCs = 0;
    // m_isScreenLocked com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b68ddbd
    m_isScreenLocked = false;
    // m_isWechatQqCall com.eprosima.idl.parser.typecode.PrimitiveTypeCode@646d64ab
 ...
 */
void PhoneStateInfo::phoneCs(int32_t _phoneCs)
{
m_phoneCs = _phoneCs;
}
 ...
 */
int32_t PhoneStateInfo::phoneCs() const
{
    return m_phoneCs;
}
 ...
 */
int32_t& PhoneStateInfo::phoneCs()
{
    return m_phoneCs;
}
 ...
 */
void PhoneStateInfo::isScreenLocked(bool _isScreenLocked)
{
m_isScreenLocked = _isScreenLocked;
}
 ...
 */
bool PhoneStateInfo::isScreenLocked() const
{
    return m_isScreenLocked;
}
 ...
 */
bool& PhoneStateInfo::isScreenLocked()
{
    return m_isScreenLocked;
}
 ...
 */
void PhoneStateInfo::isWechatQqCall(bool _isWechatQqCall)
{
m_isWechatQqCall = _isWechatQqCall;
}
 ...
 */
bool PhoneStateInfo::isWechatQqCall() const
{
    return m_isWechatQqCall;
}
 ...
 */
bool& PhoneStateInfo::isWechatQqCall()
{
    return m_isWechatQqCall;
}
