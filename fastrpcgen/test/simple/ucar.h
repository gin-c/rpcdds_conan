...
public:
     ...
     * @return Serialized size.
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const NavigationInfo& data, size_t current_alignment = 0);
...
public:
     ...
     * @return Serialized size.
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const PhoneStateInfo& data, size_t current_alignment = 0);
...
class ucar_DllAPI UCarHandle 
{
    public:
        ...
        virtual bool sendTouchEventHandle(/*in*/ int32_t action, /*in*/ int32_t width, /*in*/ int32_t height, /*in*/ int32_t count, /*in*/ const LongArray& trackID, /*in*/ const LongArray& x, /*in*/ const LongArray& y) = 0;

        
        virtual bool sendMicRecordDataHandle(/*in*/ int32_t i, /*in*/ const ShortArray& shorts, /*in*/ int32_t l) = 0;

        
        virtual bool sendKeyEventHandle(/*in*/ int32_t keyEventActionType, /*in*/ int32_t keyCodeType, /*in*/ int32_t i) = 0;

        
        virtual bool sendGotoForegroundHandle() = 0;

        
        virtual bool sendGotoBackgroundHandle() = 0;

        
        virtual bool sendVRCMDHandle(/*in*/ int32_t vrcmdType, /*in*/ const std::string& s) = 0;

        
        virtual bool notifyIsCallHungUpHandle() = 0;

        
        virtual bool notifySwitchDayOrNightHandle(/*in*/ int32_t dayNightMode) = 0;

        
        virtual bool awakenVoiceAssistantHandle(/*in*/ const ByteArray& bytes, /*in*/ const AudioFormat& audioFormat) = 0;

        
        virtual bool presetVendorCustomFieldsHandle(/*in*/ const ByteArray& bytes) = 0;

        
        virtual bool presetConnectModeHandle(/*in*/ int32_t connectMode) = 0;
...
class ucar_DllAPI UCarNotify 
{
    public:
        ...
        virtual void audioStateChanged(/*in*/ int32_t var2, /*in*/ const AudioFormat& audioFormat, /*in*/ int32_t playerState) = 0;
...
class ucar_DllAPI UCarNotifyHandle 
{
    public:
        ...
        virtual void videoInitializedHandle(/*in*/ int32_t type, /*in*/ const VideoFormat& videFormat) = 0;

        
        virtual void videoDataReceivedHandle(/*in*/ int32_t type, /*in*/ int32_t size, /*in*/ const ByteArray& byte) = 0;

        
        virtual void requestGotoHUDesktopHandle() = 0;

        
        virtual void audioStateChangedHandle(/*in*/ int32_t var2, /*in*/ const AudioFormat& audioFormat, /*in*/ int32_t playerState) = 0;

        
        virtual void audioDataReceivedHandle(/*in*/ int32_t var2, /*in*/ int32_t var3, /*in*/ const ByteArray& var4) = 0;

        
        virtual void musicInfoReceivedHandle(/*in*/ const MusicInfo& var2) = 0;

        
        virtual void navigationInfoReceivedHandle(/*in*/ const NavigationInfo& var2) = 0;

        
        virtual void phoneStateInfoReceivedHandle(/*in*/ const PhoneStateInfo& var2) = 0;

        
        virtual void micRecordRequestHandle(/*in*/ const AudioFormat& var2, /*in*/ bool var3) = 0;

        
        virtual void userInterventionNeededHandle() = 0;
