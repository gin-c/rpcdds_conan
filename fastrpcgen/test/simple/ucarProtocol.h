                ...
                public:
                    ...
                    */
                    ...
                    virtual bool activateInterface(const char* interfaceName) = 0;
                                        ...
                                        */
                                        void linkUCarImpl(UCarServerImpl &s_impl)
                                        {
                                            _UCar_s_impl = &s_impl;
                                        }
                                        ...
                                        */
                                        void linkUCarNotifyImpl(UCarProxyImpl &p_impl)
                                        {
                                            _UCar_p_impl = &p_impl;
                                        }
                     ...
                     */
                    virtual bool UCar_sendTouchEvent(/*in*/ int32_t action, /*in*/ int32_t width, /*in*/ int32_t height, /*in*/ int32_t count, /*in*/ const LongArray& trackID, /*in*/ const LongArray& x, /*in*/ const LongArray& y) = 0;
                    /*!
                     * @brief This asynchronous method implements the proxy part of the protocol for the operation sendTouchEvent.
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_sendTouchEvent_async(UCar_sendTouchEventCallbackHandler &obj, /*in*/ int32_t action, /*in*/ int32_t width, /*in*/ int32_t height, /*in*/ int32_t count, /*in*/ const LongArray& trackID, /*in*/ const LongArray& x, /*in*/ const LongArray& y) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_sendMicRecordData_async(UCar_sendMicRecordDataCallbackHandler &obj, /*in*/ int32_t i, /*in*/ const ShortArray& shorts, /*in*/ int32_t l) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_sendKeyEvent_async(UCar_sendKeyEventCallbackHandler &obj, /*in*/ int32_t keyEventActionType, /*in*/ int32_t keyCodeType, /*in*/ int32_t i) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_sendVRCMD_async(UCar_sendVRCMDCallbackHandler &obj, /*in*/ int32_t vrcmdType, /*in*/ const std::string& s) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_notifySwitchDayOrNight_async(UCar_notifySwitchDayOrNightCallbackHandler &obj, /*in*/ int32_t dayNightMode) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_awakenVoiceAssistant_async(UCar_awakenVoiceAssistantCallbackHandler &obj, /*in*/ const ByteArray& bytes, /*in*/ const AudioFormat& audioFormat) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_presetVendorCustomFields_async(UCar_presetVendorCustomFieldsCallbackHandler &obj, /*in*/ const ByteArray& bytes) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_presetConnectMode_async(UCar_presetConnectModeCallbackHandler &obj, /*in*/ int32_t connectMode) = 0;
                     ...
                     *        It has to be implemented by the child classes.
                     */
                    virtual void UCar_audioStateChanged(/*in*/ int32_t var2, /*in*/ const AudioFormat& audioFormat, /*in*/ int32_t playerState) = 0;
