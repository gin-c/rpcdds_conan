...
UCarProtocol::UCarProtocol()
    : ::protocol::UCarProtocol(), m_ddsTransport(NULL), UCar_str("UCar"), UCar_pe(NULL), UCar_se(NULL) {}
    ...
    if (m_ddsTransport != NULL) {
        ...
        if (strcmp(interfaceName, "UCar") == 0) {
            ...
            if (behaviour == ::transport::PROXY_BEHAVIOUR) {
                UCar_pe = dynamic_cast<eprosima::rpc::transport::dds::RTPSProxyProcedureEndpoint *>(
                    m_ddsTransport->createProcedureEndpoint(
                        UCar_str, UCar_requestPlugin.getName(), requesttopicName.c_str(), UCar_replyPlugin.getName(),
                        ...
                        UCarProtocol::UCar_proxy, sizeof(UCar_Reply)));
            }
            if (behaviour == ::transport::SERVER_BEHAVIOUR) {
                UCar_se = dynamic_cast<eprosima::rpc::transport::dds::RTPSServerProcedureEndpoint *>(
                    m_ddsTransport->createProcedureEndpoint(
                        UCar_str, UCar_replyPlugin.getName(), replytopicName.c_str(), UCar_requestPlugin.getName(),
                        ...
                        UCarProtocol::UCar_serve, sizeof(UCar_Request)));
            }
        }
...
void UCarProtocol::UCar_serve(eprosima::rpc::protocol::Protocol &protocol, void *_data,
    ...
    switch (requestData.data()._d()) {
        case (int32_t)0x81D4B2D7: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->sendTouchEventHandle(sendId, action, width, height, count,
                                                                           trackID, x, y);
        ...
        case (int32_t)0xD727D4CE: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->sendMicRecordDataHandle(sendId, i, shorts, l);
        ...
        case (int32_t)0x44278473: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->sendKeyEventHandle(sendId, keyEventActionType, keyCodeType, i);
        ...
        case (int32_t)0x5C709BCF: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->sendGotoForegroundHandle(sendId);
        ...
        case (int32_t)0x57CBA9AE: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->sendGotoBackgroundHandle(sendId);
        ...
        case (int32_t)0x873F597B: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->sendVRCMDHandle(sendId, vrcmdType, s);
        ...
        case (int32_t)0xA5D0AE3A: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->notifyIsCallHungUpHandle(sendId);
        ...
        case (int32_t)0x8ED99DB4: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->notifySwitchDayOrNightHandle(sendId, dayNightMode);
        ...
        case (int32_t)0x1B523A37: {
            ...
            audioFormat =
                std::move(requestData.data().awakenVoiceAssistant().audioFormat());  // TODO Probar que esto funciona.

            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->awakenVoiceAssistantHandle(sendId, bytes, audioFormat);
        ...
        case (int32_t)0x68A2963D: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->presetVendorCustomFieldsHandle(sendId, bytes);
        ...
        case (int32_t)0x24914CCE: {
            ...
            try {
                if (_protocol._UCar_s_impl != NULL) {
                    return_ = _protocol._UCar_s_impl->presetConnectModeHandle(sendId, connectMode);
...
void UCarProtocol::UCar_proxy(eprosima::rpc::protocol::Protocol &protocol, void *_data,
                              eprosima::rpc::transport::Endpoint *endpoint) {
    UCarProtocol &_protocol = dynamic_cast<UCarProtocol &>(protocol);
    ...
    switch (replyData.data()._d()) {
        ...
        case (int32_t)0xBC612B69: {
            ...
            videFormat =
                std::move(replyData.data().videoInitialized().result().videFormat());  // TODO Probar que esto funciona.
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->videoInitializedHandle(sendId, type, videFormat);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0x0AED1DEF: {
            ...
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->videoDataReceivedHandle(sendId, type, size, byte);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0xB9DBD217: {
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->requestGotoHUDesktopHandle(sendId);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0x2ED6B8C6: {
            ...
            audioFormat = std::move(replyData.data().audioStateChanged().result().audioFormat());  // TODO Probar que
                                                                                                   // esto funciona.
            playerState = replyData.data().audioStateChanged().result().playerState();
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->audioStateChangedHandle(sendId, var2, audioFormat, playerState);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0x1FCD31F5: {
            ...
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->audioDataReceivedHandle(sendId, var2, var3, var4);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0x984FF8BF: {
            ...
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->musicInfoReceivedHandle(sendId, var2);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0xCADE4888: {
            NavigationInfo var2;
            var2 =
                std::move(replyData.data().navigationInfoReceived().result().var2());  // TODO Probar que esto funciona.
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->navigationInfoReceivedHandle(sendId, var2);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0x2F2D8A67: {
            PhoneStateInfo var2;
            var2 =
                std::move(replyData.data().phoneStateInfoReceived().result().var2());  // TODO Probar que esto funciona.
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->phoneStateInfoReceivedHandle(sendId, var2);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0xF58271B2: {
            ...
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->micRecordRequestHandle(sendId, var2, var3);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
        ...
        case (int32_t)0x2F189293: {
            try {
                if (_protocol._UCar_p_impl != NULL) {
                    _protocol._UCar_p_impl->userInterventionNeededHandle(sendId);
                }
                // TODO Send exception.
            } catch (const ServerInternalException &) {
            }
...
bool UCarProtocol::UCar_sendTouchEvent(/*in*/ int32_t action, /*in*/ int32_t width, /*in*/ int32_t height,
                                       /*in*/ int32_t count, /*in*/ const LongArray &trackID, /*in*/ const LongArray &x,
                                       /*in*/ const LongArray &y) {
...
void UCarProtocol::UCar_sendTouchEvent_async(UCar_sendTouchEventCallbackHandler &obj, /*in*/ int32_t action,
...
void UCarProtocol::UCar_sendMicRecordData_async(UCar_sendMicRecordDataCallbackHandler &obj, /*in*/ int32_t i,
...
void UCarProtocol::UCar_sendKeyEvent_async(UCar_sendKeyEventCallbackHandler &obj, /*in*/ int32_t keyEventActionType,
...
void UCarProtocol::UCar_sendVRCMD_async(UCar_sendVRCMDCallbackHandler &obj, /*in*/ int32_t vrcmdType,
...
void UCarProtocol::UCar_notifySwitchDayOrNight_async(UCar_notifySwitchDayOrNightCallbackHandler &obj,
                                                     /*in*/ int32_t dayNightMode) {
    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
    UCar_Request instance;
...
void UCarProtocol::UCar_awakenVoiceAssistant_async(UCar_awakenVoiceAssistantCallbackHandler &obj,
...
void UCarProtocol::UCar_presetVendorCustomFields_async(UCar_presetVendorCustomFieldsCallbackHandler &obj,
                                                       /*in*/ const ByteArray &bytes) {
    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
    UCar_Request instance;
...
void UCarProtocol::UCar_presetConnectMode_async(UCar_presetConnectModeCallbackHandler &obj,
                                                /*in*/ int32_t connectMode) {
    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
    UCar_Request instance;
...
void UCarProtocol::UCar_audioStateChanged(/*in*/ int32_t var2, /*in*/ const AudioFormat &audioFormat,
                                          /*in*/ int32_t playerState) {
    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
    UCar_Reply replyData;
