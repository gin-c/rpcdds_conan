...
public:
     ...
     */
    RPCUSERDllExport static void UCar_serve(eprosima::rpc::protocol::Protocol& protocol, void* data,
     ...
     * @param endpoint Pointer to the endpoint that sent the request reply. Cannot be NULL.
     */
    static void UCar_proxy(eprosima::rpc::protocol::Protocol& protocol, void* data,
                           eprosima::rpc::transport::Endpoint* endpoint);
    ...
    RPCUSERDllExport bool UCar_sendTouchEvent(/*in*/ int32_t action, /*in*/ int32_t width, /*in*/ int32_t height,
                                              /*in*/ int32_t count, /*in*/ const LongArray& trackID,
     ...
     * It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_sendTouchEvent_async(UCar_sendTouchEventCallbackHandler& obj, /*in*/ int32_t action,
     ...
     * It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_sendMicRecordData_async(UCar_sendMicRecordDataCallbackHandler& obj, /*in*/ int32_t i,
    ...
    RPCUSERDllExport bool UCar_sendKeyEvent(/*in*/ int32_t keyEventActionType, /*in*/ int32_t keyCodeType,
                                            /*in*/ int32_t i);
     ...
     * It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_sendKeyEvent_async(UCar_sendKeyEventCallbackHandler& obj,
                                                  /*in*/ int32_t keyEventActionType, /*in*/ int32_t keyCodeType,
                                                  /*in*/ int32_t i);
     ...
     * It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_sendVRCMD_async(UCar_sendVRCMDCallbackHandler& obj, /*in*/ int32_t vrcmdType,
     ...
     * notifySwitchDayOrNight. It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_notifySwitchDayOrNight_async(UCar_notifySwitchDayOrNightCallbackHandler& obj,
    ...
    RPCUSERDllExport bool UCar_awakenVoiceAssistant(/*in*/ const ByteArray& bytes,
     ...
     * It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_awakenVoiceAssistant_async(UCar_awakenVoiceAssistantCallbackHandler& obj,
    ...
    /*!
     * @brief This asynchronous method implements the proxy part of the protocol for the operation
     * presetVendorCustomFields. It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_presetVendorCustomFields_async(UCar_presetVendorCustomFieldsCallbackHandler& obj,
                                                              /*in*/ const ByteArray& bytes);
     ...
     * It is called from the Proxy interface.
     */
    RPCUSERDllExport void UCar_presetConnectMode_async(UCar_presetConnectModeCallbackHandler& obj,
