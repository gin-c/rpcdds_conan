...
UCarProxy::UCarProxy(eprosima::rpc::strategy::ServerStrategy& strategy,
...
bool UCarProxy::sendTouchEvent(/*in*/ int32_t action, /*in*/ int32_t width, /*in*/ int32_t height, /*in*/ int32_t count,
                               /*in*/ const LongArray& trackID, /*in*/ const LongArray& x, /*in*/ const LongArray& y) {
    bool return_ = dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
                       .UCar_sendTouchEvent(action, width, height, count, trackID, x, y);
    return return_;
}
void UCarProxy::sendTouchEvent_async(UCar_sendTouchEventCallbackHandler& obj, /*in*/ int32_t action,
                                     /*in*/ int32_t width, /*in*/ int32_t height, /*in*/ int32_t count,
                                     /*in*/ const LongArray& trackID, /*in*/ const LongArray& x,
                                     /*in*/ const LongArray& y) {
    dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
        .UCar_sendTouchEvent_async(obj, action, width, height, count, trackID, x, y);
}
...
void UCarProxy::sendMicRecordData_async(UCar_sendMicRecordDataCallbackHandler& obj, /*in*/ int32_t i,
...
bool UCarProxy::sendKeyEvent(/*in*/ int32_t keyEventActionType, /*in*/ int32_t keyCodeType, /*in*/ int32_t i) {
    bool return_ = dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
                       .UCar_sendKeyEvent(keyEventActionType, keyCodeType, i);
    return return_;
}
void UCarProxy::sendKeyEvent_async(UCar_sendKeyEventCallbackHandler& obj, /*in*/ int32_t keyEventActionType,
                                   /*in*/ int32_t keyCodeType, /*in*/ int32_t i) {
    dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
        .UCar_sendKeyEvent_async(obj, keyEventActionType, keyCodeType, i);
}

bool UCarProxy::sendGotoForeground() {
    bool return_ = dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol()).UCar_sendGotoForeground();
    return return_;
}
...
bool UCarProxy::sendGotoBackground() {
    bool return_ = dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol()).UCar_sendGotoBackground();
    return return_;
}
...
bool UCarProxy::sendVRCMD(/*in*/ int32_t vrcmdType, /*in*/ const std::string& s) {
    bool return_ = dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol()).UCar_sendVRCMD(vrcmdType, s);
    return return_;
}
void UCarProxy::sendVRCMD_async(UCar_sendVRCMDCallbackHandler& obj, /*in*/ int32_t vrcmdType,
...
bool UCarProxy::notifyIsCallHungUp() {
    bool return_ = dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol()).UCar_notifyIsCallHungUp();
    return return_;
}
...
void UCarProxy::notifySwitchDayOrNight_async(UCar_notifySwitchDayOrNightCallbackHandler& obj,
                                             /*in*/ int32_t dayNightMode) {
    dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
        .UCar_notifySwitchDayOrNight_async(obj, dayNightMode);
}

bool UCarProxy::awakenVoiceAssistant(/*in*/ const ByteArray& bytes, /*in*/ const AudioFormat& audioFormat) {
    bool return_ = dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
                       .UCar_awakenVoiceAssistant(bytes, audioFormat);
    return return_;
}
void UCarProxy::awakenVoiceAssistant_async(UCar_awakenVoiceAssistantCallbackHandler& obj, /*in*/ const ByteArray& bytes,
                                           /*in*/ const AudioFormat& audioFormat) {
    dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
        .UCar_awakenVoiceAssistant_async(obj, bytes, audioFormat);
}
...
void UCarProxy::presetVendorCustomFields_async(UCar_presetVendorCustomFieldsCallbackHandler& obj,
