...
public:
    ...
    user_cpp_DllExport static void copy_data(UCar_Request *dst, const UCar_Request *src);
};
...
public:
    ...
    user_cpp_DllExport static void copy_data(UCar_Reply *dst, const UCar_Reply *src);
};
