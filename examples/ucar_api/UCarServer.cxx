...
UCarServer::UCarServer(eprosima::rpc::strategy::ServerStrategy& strategy,
...
void UCarServer::audioStateChanged(/*in*/ int32_t var2, /*in*/ const AudioFormat& audioFormat,
                                   /*in*/ int32_t playerState) {
    dynamic_cast<eprosima::rpc::protocol::UCarProtocol&>(getProtocol())
        .UCar_audioStateChanged(var2, audioFormat, playerState);
}
