 ...
 * @ingroup CALCULATOR
 */
class RPCUSERDllExport CalculatorServer : public eprosima::rpc::server::Server, public CalculatorNotify
{
    public:
        ...
        virtual ~CalculatorServer();
                        ...
                        void videoInitialized(/*in*/ VideoType type, /*in*/ const VideoFormat& videFormat);
                
                        //! @brief Proxy method for the operation videoDataReceived.
                        void videoDataReceived(/*in*/ VideoType type, /*in*/ int32_t size, /*in*/ const ByteArray& byte);
