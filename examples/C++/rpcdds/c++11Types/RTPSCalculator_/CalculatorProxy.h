...
class RPCUSERDllExport CalculatorProxy : public eprosima::rpc::proxy::Proxy, public Calculator
{
    public:
         ...
         */
        CalculatorProxy(eprosima::rpc::strategy::ServerStrategy &strategy, eprosima::rpc::transport::ProxyTransport &transport,
        ...
        virtual ~CalculatorProxy();
                ...
                void sendTouchEvent_async(Calculator_sendTouchEventCallbackHandler &obj, /*in*/ int32_t action, /*in*/ int32_t width, /*in*/ int32_t height, /*in*/ int32_t count, /*in*/ const LongArray& trackID, /*in*/ const LongArray& x, /*in*/ const LongArray& y);
                ...
                void sendGotoForeground_async(Calculator_sendGotoForegroundCallbackHandler &obj);
