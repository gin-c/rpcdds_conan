...
void CalculatorServer::videoInitialized(/*in*/ VideoType type, /*in*/ const VideoFormat& videFormat)
{
    dynamic_cast<eprosima::rpc::protocol::CalculatorProtocol&>(getProtocol()).Calculator_videoInitialized(type, videFormat);
}

void CalculatorServer::videoDataReceived(/*in*/ VideoType type, /*in*/ int32_t size, /*in*/ const ByteArray& byte)
{
    dynamic_cast<eprosima::rpc::protocol::CalculatorProtocol&>(getProtocol()).Calculator_videoDataReceived(type, size, byte);
}
