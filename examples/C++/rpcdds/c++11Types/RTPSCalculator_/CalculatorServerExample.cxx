...
int main(int argc, char **argv) {
    if (argc != 2) {
        std::cout << "Usage: CalculatorServer <xml path>" << std::endl;
        return 0;
    }
    ...
    try {
        ...
        transport = new RTPSServerTransport(participant, "CalculatorService", "Instance");
    ...
    while (1) {
        ...
        server->videoInitialized(VideoType::STREAM_COMMUNICATION, videoFormat);
        std::cout << "videoInitialized::" << std::endl;
        std::vector<char> byte = gengerVectorChar(40960);
        ...
        server->videoDataReceived(VideoType::STREAM_COMMUNICATION, byte.size(), byte);
    }
