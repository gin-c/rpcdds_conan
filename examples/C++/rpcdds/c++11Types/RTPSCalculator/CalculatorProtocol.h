                    ...
                    */
                    ...
                    virtual bool activateInterface(const char* interfaceName) = 0;
                                        ...
                                        */
                                        ...
                                        {
                                          _Calculator_server_impl = &s_impl;
                                        }
...
//                    virtual void Calculator_status_notify_listen(Calculator_additionCallbackHandler &obj) = 0;
                    // notify 在 protocol 中声明定义，在server中调用
                    virtual void Calculator_status_notify(/*in*/ int32_t value1, /*in*/ int32_t value2) = 0;
                    /*!
                  ...
                  protected:
                    ...
                    CalculatorProtocol() : Protocol()
                                        ...
                                        , _Calculator_server_impl(NULL)
                    ,_Calculator_proxy_impl(NULL)
                    ...
                    virtual ~CalculatorProtocol(){}
                	                    ...
                	                    CalculatorServerImpl *_Calculator_server_impl;
                                            CalculatorProxyImpl *_Calculator_proxy_impl;
