                ...
                public eprosima::fastrtps::PublisherListener
                {
                    public:
                        ...
                        RPC_DllAPI int initialize(const char *name, const char *writertypename,
                                ...
                                RTPSTransport::Destroy_data destroy_data, RTPSTransport::ProcessFunc processFunc,size_t dataSize);
...
//                        RPC_DllAPI eprosima::rpc::ReturnMessage notify_listen(int32_t d, RTPSAsyncTask *task);
...
//                        std::map<int64_t, RecvPoint&> listen_threads;
