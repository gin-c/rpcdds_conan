...
public:
     ...
     */
    inline eprosima::fastrtps::Participant *getParticipant() const { return m_participant; }
     ...
     * @param writertypename The type name of the topic that the procedure endpoint uses in the datawriter. It cannot be
     * NULL.
     * @param readertypename The type name of the topic that the procedure endpoint uses in the datareader. It cannot be
     * NULL.
     ...
     * TODO
     */
    virtual eprosima::rpc::transport::Endpoint *createProcedureEndpoint(
        const char *name, const char *writertypename, const char *writertopicname, const char *readertypename,
        const char *readertopicname, Create_data create_data, Copy_data copy_data, Destroy_data destroy_data,
