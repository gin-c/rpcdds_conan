...
CalculatorProxy::CalculatorProxy(eprosima::rpc::strategy::ServerStrategy &strategy, eprosima::rpc::transport::ProxyTransport &transport,
                                 eprosima::rpc::protocol::CalculatorProtocol &protocol, CalculatorProxyImpl &servant) : Proxy(strategy, transport, protocol),_impl(servant)
{
...
//void CalculatorProxy::status_notify_listen(Calculator_additionCallbackHandler &obj)
//{
//    dynamic_cast<eprosima::rpc::protocol::CalculatorProtocol&>(getProtocol()).Calculator_status_notify_listen(obj);
//}
