 ...
 * This source file contains the definition of the protocol used to create DDS
 *messages.
 *
    ...
    if (m_ddsTransport != NULL) {
        ...
        if (strcmp(interfaceName, "Calculator") == 0) {
            ...
            if (behaviour == ::transport::PROXY_BEHAVIOUR) {
                Calculator_pe = dynamic_cast<eprosima::rpc::transport::dds::RTPSProxyProcedureEndpoint *>(
                    m_ddsTransport->createProcedureEndpoint(
                        Calculator_str, Calculator_requestPlugin.getName(), requesttopicName.c_str(),
                        Calculator_replyPlugin.getName(), replytopicName.c_str(),
                        ...
                        CalculatorProtocol::Calculator_proxy, sizeof(Calculator_Reply)));
            }

            if (behaviour == ::transport::SERVER_BEHAVIOUR) {
                Calculator_se = dynamic_cast<eprosima::rpc::transport::dds::RTPSServerProcedureEndpoint *>(
                    m_ddsTransport->createProcedureEndpoint(
                        Calculator_str, Calculator_replyPlugin.getName(), replytopicName.c_str(),
                        Calculator_requestPlugin.getName(), requesttopicName.c_str(),
                        ...
                        CalculatorProtocol::Calculator_serve, sizeof(Calculator_Request)));
            }
        }
...
void CalculatorProtocol::Calculator_proxy(eprosima::rpc::protocol::Protocol &protocol, void *_data,
    ...
    switch (replyData.data()._d()) {
        case (int32_t)0xBBBBBBBB: {
            ...
            value1 = replyData.data().status_notify().result().value1_();
            value2 = replyData.data().status_notify().result().value2_();

            try {
                if (_protocol._Calculator_proxy_impl != NULL) {
                    _protocol._Calculator_proxy_impl->status_notify(value1,value2);
                }
                // TODO Send exception.
...
void CalculatorProtocol::Calculator_serve(eprosima::rpc::protocol::Protocol &protocol, void *_data,
                                          eprosima::rpc::transport::Endpoint *endpoint) {
    CalculatorProtocol &_protocol = dynamic_cast<CalculatorProtocol &>(protocol);
    ...
    switch (requestData.data()._d()) {
        ...
        case (int32_t)0xCBC6CEAA: {
            ...
            try {
                if (_protocol._Calculator_server_impl != NULL) {
                    return_ = _protocol._Calculator_server_impl->addition(value1, value2);
        ...
        case (int32_t)0xCBC6CEAA: {
            ...
            replyData.data()._d() = 0xBBBBBBBB;

            replyData.data().status_notify()._d() = 0;

            replyData.data().status_notify().result().value1_(111);
            replyData.data().status_notify().result().value2_(222);
        ...
        case (int32_t)0xCA019A14: {
            ...
            try {
                if (_protocol._Calculator_server_impl != NULL) {
                    return_ = _protocol._Calculator_server_impl->subtraction(value1, value2);
...
int32_t CalculatorProtocol::Calculator_addition(/*in*/ int32_t value1,
                                                /*in*/ int32_t value2) {
...
void CalculatorProtocol::Calculator_addition_async(Calculator_additionCallbackHandler &obj, /*in*/ int32_t value1,
                                                   /*in*/ int32_t value2) {
    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
    Calculator_Request instance;
...
void CalculatorProtocol::Calculator_status_notify(/*in*/ int32_t value1, /*in*/ int32_t value2) {
    int32_t return_ = 0;
    Calculator_Reply replyData;
    ...
    replyData.data().status_notify().result().value1_(value1);
    replyData.data().status_notify().result().value2_(value2);

    Calculator_se->broadcast(&replyData);
}
//
//void CalculatorProtocol::Calculator_status_notify_listen(Calculator_additionCallbackHandler &obj) {
//    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
//    Calculator_Request instance;
//    Calculator_additionTask *task = new Calculator_additionTask(obj);
//
//    int32_t _d = 0xBBBBBBBB;
//
//    retcode = Calculator_pe->notify_listen(_d, task);
//
//    switch (retcode) {
//        case CLIENT_INTERNAL_ERROR:
//            throw ClientInternalException("Error in client side");
...
int32_t CalculatorProtocol::Calculator_subtraction(/*in*/ int32_t value1,
                                                   /*in*/ int32_t value2) {
    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
    int32_t return_ = 0;
    Calculator_Request instance;
...
void CalculatorProtocol::Calculator_subtraction_async(Calculator_subtractionCallbackHandler &obj, /*in*/ int32_t value1,
                                                      /*in*/ int32_t value2) {
    ReturnMessage retcode = CLIENT_INTERNAL_ERROR;
    Calculator_Request instance;
