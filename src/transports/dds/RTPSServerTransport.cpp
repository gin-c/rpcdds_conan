...
void RTPSServerTransport::process(RTPSServerProcedureEndpoint *endpoint,void *data, RTPSTransport::Destroy_data destroy_data)
{
...
const char* RTPSServerTransport::getInstanceName() const
{
