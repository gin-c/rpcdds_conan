        ...
        RTPSTransport::ProcessFunc processFunc, size_t dataSize)
{
    ...
    if(pe != NULL)
    {
        if(pe->initialize(name, writertypename, writertopicname, readertypename, readertopicname, create_data, copy_data, destroy_data, processFunc, dataSize) == 0)
        {
...
void RTPSProxyTransport::process(RTPSProxyProcedureEndpoint *endpoint, void *data, RTPSTransport::Destroy_data destroy_data)
{
